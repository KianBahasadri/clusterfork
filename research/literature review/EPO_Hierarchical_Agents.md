...
*   *Implementation Note:* The code suggests this is trained using the PDDL (Planning Domain Definition Language) plans available in the ALFRED dataset as ground truth for subgoals.
