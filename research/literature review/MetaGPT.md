...
1.  **Role Specialization:** We should explicitly define "Architect" and "Coder" personas. The Architect should focus on file structure and interfaces *before* any code is written.
...
*   **Interpretability:** The intermediate outputs (PRDs, designs) make it easy for human users to understand *why* the system built the software the way it did.
