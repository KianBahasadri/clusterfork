...
class DashHandler(BaseHTTPRequestHandler):
    ...
    def h_section_list(self, verb: str, route: str):
        ...
        self.send_json({
            ...
            "metric_totals": files.get("metric_totals"),
            "total_code_lines": files.get("total_code_lines"),
            "total_blank_lines": files.get("total_blank_lines"),
            "total_comment_lines": files.get("total_comment_lines"),
