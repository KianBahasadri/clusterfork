...
* Left-align prose and identifiers. Right-align numeric values, timestamps, currency, and measurements; use `font-variant-numeric: tabular-nums` and `--mono` for those cells.
