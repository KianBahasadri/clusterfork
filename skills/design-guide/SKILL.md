...
- Read [Weather](references/weather.md) for a visual temperature comparison with the previous week, weather glyph sizing and placement, and optional sunrise/sunset times, UV index, and rain chance.
